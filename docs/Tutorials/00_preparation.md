# Essential Knowledge For Web devoloment

## Front-end

- [HTML5 Basics](https://www.w3schools.com/html/default.asp)
...
- [.NET core Tutorial in 5 minutes](https://dotnet.microsoft.com/en-us/learn/dotnet/hello-world-tutorial/intro)
